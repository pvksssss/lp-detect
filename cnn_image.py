...
ap.add_argument('-i', '--image', required=False, default='D:\\2024_2025\\TGMT\\Biensoxe\\License-Plate-Recognition-main\\License-Plate-Recognition-main\\test_image\\5.jpg', help='path to input image')
args = ap.parse_args()
